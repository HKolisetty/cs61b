...
public class TestMultiWordK0Hyponyms {
    ...
    public static final String MEDIUM_TEXT = "data/ngrams/top_14377_words.csv";
    ...
    public void test5() {
        NgordnetQueryHandler studentHandler = AutograderBuddy.getHyponymHandler(
                MEDIUM_TEXT, TOTAL_COUNTS_FILE, LARGE_SYNSET_FILE, LARGE_HYPONYM_FILE);
        List<String> words = List.of("part", "oral_fissure");
